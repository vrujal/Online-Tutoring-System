...
if (isset($_GET['id'])) {
    ...
    // $update2 = mysqli_query($conn, "UPDATE course_request SET delete_flag = 1 where course_id='$course_id'");
    $sql = $conn->query("Update course_request set delete_flag ='1' where course_id=$course_id");
